...
// Racine de l'application : le dossier parent en local, ou le dossier web
// lorsque l'hébergeur impose de tout placer dans htdocs.
...
require_once $appRoot . '/src/Core/Autoloader.php';
